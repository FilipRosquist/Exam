...
const Header = () => {
  ...
  return(
    <div className="fixed top-0 left-0 w-full x-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
